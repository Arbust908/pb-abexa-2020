export { default as AcordionCases } from '../..\\components\\AcordionCases.vue'
export { default as Carousel } from '../..\\components\\Carousel.vue'
export { default as ClientLogo } from '../..\\components\\ClientLogo.vue'
export { default as CustomDropdown } from '../..\\components\\CustomDropdown.vue'
...
export const LazyAcordionCases = import('../..\\components\\AcordionCases.vue' /* webpackChunkName: "components_AcordionCases" */).then(c => c.default || c)
export const LazyCarousel = import('../..\\components\\Carousel.vue' /* webpackChunkName: "components_Carousel" */).then(c => c.default || c)
export const LazyClientLogo = import('../..\\components\\ClientLogo.vue' /* webpackChunkName: "components_ClientLogo" */).then(c => c.default || c)
export const LazyCustomDropdown = import('../..\\components\\CustomDropdown.vue' /* webpackChunkName: "components_CustomDropdown" */).then(c => c.default || c)
export const LazyFlag = import('../..\\components\\Flag.vue' /* webpackChunkName: "components_Flag" */).then(c => c.default || c)
